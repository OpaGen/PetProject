...
Procedure EasyZAZ;   //Функция зашифровки простой
  var
     X,Y,XM,YM:Word;
 ...
 for X :=0 to form1.image1.Width  do     //шифрую первое изображение в bmp файле
    for Y :=0 to form1.image1.Height do
       ...
       End;
 form1.Image2.Picture.Assign(btm);//выгружаю bmp файл в image2
 Form1.Image10.Picture:=form1.Image2.Picture;
 form1.image2.Proportional:=true;
 btm.Free;
 Form1.ProgressBar.Visible:=false;
 ShowMessage('Зашифрованно')
  end;

Procedure EasyRAZ;   //Функция разшифровки простой
var
    X,Y,XM,YM:Word;
    btm: TBitmap;
    progres:integer;
